...
contract('Planken', function(accounts) {
  it("should put 0 Planken in the first account", function() {
    return Planken.deployed().then(function(instance) {
      return instance.getBalance.call(accounts[0]);
    }).then(function(balance) {
      assert.equal(balance.valueOf(), 0, "0 wasn't in the first account");
    });
  });
  it("should add planken correctly", function() {
    var meta;
    ...
    return Planken.deployed().then(function(instance) {
      ...
      return meta.addPlanken(account, amount);
    }).then(function() {
      return meta.getBalance.call(account);
    }).then(function(balance) {
  ...
  it("should send planken correctly", function() {
    var meta;
